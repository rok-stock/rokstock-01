...
- **KRX상장종목정보가 미승인**이면 시세 응답에서 마스터를 유도한다(법인등록번호 없음).
  승인 후 재실행하면 채워진다 — 법인등록번호는 기업 리포트(G6)의 조인 키다.
- **지수시세정보가 미승인**이면 빈 지수 파일을 만든다. 벤치마크(G7) 전에 재실행.
...
| KRX상장종목정보 | 종목 마스터(법인등록번호) | 승인 대기 — 시세로 대체 중 |
| 지수시세정보 | KOSPI 지수 (G7 벤치마크) | 승인 대기 |
| 기업재무정보·기업기본정보 | 기업 리포트 (G6) | 승인 대기 |
