...
export const GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  dividendYield: {
    term: "배당수익률",
    description:
      "최근 1년 주당 배당금 ÷ 현재 주가. \"은행 이자처럼 주가 대비 몇 %를 현금으로 돌려주나\"입니다. 배당이 높다고 무조건 좋은 건 아니에요 — 주가가 떨어져서 수익률이 높아 보이는 경우도 있으니까요.",
  },
  parValue: {
    term: "액면가",
    description:
      "주권에 적힌 명목상 1주 가격 (100원·500원·5,000원 등). 실제 주가와는 무관하고, 자본금 계산(액면가 × 발행주식수)과 액면분할 뉴스를 이해할 때 쓰이는 개념입니다.",
  },
  marketCap: {
    term: "시가총액",
    description:
      "주가 × 발행주식수 — \"회사를 통째로 사려면 얼마\"입니다. 주가 5만 원짜리가 50만 원짜리보다 싼 게 아니에요. 회사의 크기는 주가가 아니라 시가총액으로 비교합니다.",
  },
  kospiIndex: {
    term: "코스피지수",
    description:
      "KOSPI 상장 종목 전체의 시가총액을 1980년 기준(100)과 비교한 숫자. 지수가 2,500이면 그때보다 시장 전체가 25배 커졌다는 뜻이에요. 개별 종목이 아니라 \"시장 전체의 체온\"을 읽는 도구입니다.",
  },
};
